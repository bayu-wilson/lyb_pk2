...
pkdata = pd.read_csv("../output/pk_mocks_lyb_nocorr_n5000.csv") # continuum_correction/pk_errboot_obs_corrNR_continuum_uncorrected.txt")
pkdata2 = pd.read_csv("../output/pk_mocks_lyb_nocorr_n5000.csv")
...
ax[0,1].text(1.2, 0.5,r"$N_{keepDLA}-N_{takeDLA}$", ha='center', va='center', transform=ax[0,1].transAxes,fontsize=20,rotation=-90)
