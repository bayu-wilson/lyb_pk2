...
pkdata_keepingDLA = pd.read_csv("../output/pk_errboot_obs_lyb_nocorr_DLAFalse_metalFalse_boot0.csv")
pkdata_removingDLA = pd.read_csv("../output/pk_errboot_obs_lyb_nocorr_DLATrue_metalFalse_boot0.csv")
