...
pkdata = pd.read_csv("../output/pk_errboot_obs_lyb_wNR_ADC_DLATrue_metalFalse_res0_nb100.csv") #../output/dla_comparison/pk_errboot_obs_corrNR_keepingDLAs.txt")#inis.save_pk_with_err_path)
pkdata2 = pd.read_csv("../output/pk_errboot_obs_lyb_wNR_DLATrue_metalFalse_res0_nb100.csv")   #"../output/dla_comparison/pk_errboot_obs_corrNR_removingDLAs.txt")#inis.save_pk_with_err_path)
