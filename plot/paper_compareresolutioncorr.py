...
pkdata2 = pd.read_csv("../output/pk_errboot_obs_lyb_wNR_DLATrue_metalFalse_res1_nb100.csv")   #"../output/dla_comparison/pk_errboot_obs_corrNR_removingDLAs.txt")#inis.save_pk_with_err_path)
...
figname = "figures/resolutioncomp.pdf"
